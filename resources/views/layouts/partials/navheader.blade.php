<div class="navbar-header">
    <div class="d-flex">
        ...
        <!-- App Search-->
        <form class="app-search d-none d-md-block d-none">
            ...
            <div class="dropdown-menu dropdown-menu-lg d-none" id="search-dropdown">
        ...
        <div class="dropdown ms-1 topbar-head-dropdown header-item d-none">
            ...
            <div class="dropdown-menu dropdown-menu-end">
                ...
                <a href="javascript:void(0);" class="dropdown-item notify-item language" data-lang="gr" title="German">
                    <img src="assets/images/flags/germany.svg" alt="user-image" class="me-2 rounded" height="18"> <span
